...
mavenPublishing {
    coordinates("io.github.bodenberg", "appdimens-dynamic-units", libraryVersion)
    configure(AndroidSingleVariantLibrary())
    pom {
        name.set("AppDimens Dynamic — Physical Units")
        description.set("Physical units (mm / cm / inch) helpers.")
