...
mavenPublishing {
    coordinates("io.github.bodenberg", "appdimens-dynamic-auto", libraryVersion)
    configure(AndroidSingleVariantLibrary())
    pom {
        name.set("AppDimens Dynamic — Auto")
        description.set("Linear / auto scaling strategy (asdp / code.auto).")
...
android {
    namespace = "com.appdimens.dynamic.auto"
    compileSdk = 36
    defaultConfig {
        minSdk = 24
