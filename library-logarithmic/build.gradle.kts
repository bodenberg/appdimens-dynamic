...
mavenPublishing {
    coordinates("io.github.bodenberg", "appdimens-dynamic-logarithmic", libraryVersion)
    configure(AndroidSingleVariantLibrary())
    pom {
        name.set("AppDimens Dynamic — Logarithmic")
        description.set("Logarithmic scaling strategy (logsdp / code.logarithmic).")
