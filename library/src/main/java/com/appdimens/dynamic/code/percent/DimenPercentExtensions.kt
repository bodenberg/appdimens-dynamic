 ...
 */
fun Number.psdpPh(context: Context): Float = this.toDynamicPercentPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PH)
fun Number.psdpPha(context: Context): Float = this.toDynamicPercentPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PH, applyAspectRatio = true)
fun Number.psdpPhi(context: Context): Float = this.toDynamicPercentPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PH, ignoreMultiWindows = true)
fun Number.psdpPhia(context: Context): Float = this.toDynamicPercentPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PH, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.psdpLh(context: Context): Float = this.toDynamicPercentPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LH)
fun Number.psdpLha(context: Context): Float = this.toDynamicPercentPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LH, applyAspectRatio = true)
fun Number.psdpLhi(context: Context): Float = this.toDynamicPercentPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LH, ignoreMultiWindows = true)
fun Number.psdpLhia(context: Context): Float = this.toDynamicPercentPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LH, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.psdpPw(context: Context): Float = this.toDynamicPercentPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PW)
fun Number.psdpPwa(context: Context): Float = this.toDynamicPercentPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PW, applyAspectRatio = true)
fun Number.psdpPwi(context: Context): Float = this.toDynamicPercentPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PW, ignoreMultiWindows = true)
fun Number.psdpPwia(context: Context): Float = this.toDynamicPercentPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PW, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.psdpLw(context: Context): Float = this.toDynamicPercentPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LW)
fun Number.psdpLwa(context: Context): Float = this.toDynamicPercentPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LW, applyAspectRatio = true)
fun Number.psdpLwi(context: Context): Float = this.toDynamicPercentPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LW, ignoreMultiWindows = true)
fun Number.psdpLwia(context: Context): Float = this.toDynamicPercentPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LW, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.phdpLw(context: Context): Float = this.toDynamicPercentPx(context, DpQualifier.HEIGHT, Inverter.PH_TO_LW)
fun Number.phdpLwa(context: Context): Float = this.toDynamicPercentPx(context, DpQualifier.HEIGHT, Inverter.PH_TO_LW, applyAspectRatio = true)
fun Number.phdpLwi(context: Context): Float = this.toDynamicPercentPx(context, DpQualifier.HEIGHT, Inverter.PH_TO_LW, ignoreMultiWindows = true)
fun Number.phdpLwia(context: Context): Float = this.toDynamicPercentPx(context, DpQualifier.HEIGHT, Inverter.PH_TO_LW, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.phdpPw(context: Context): Float = this.toDynamicPercentPx(context, DpQualifier.HEIGHT, Inverter.LH_TO_PW)
fun Number.phdpPwa(context: Context): Float = this.toDynamicPercentPx(context, DpQualifier.HEIGHT, Inverter.LH_TO_PW, applyAspectRatio = true)
fun Number.phdpPwi(context: Context): Float = this.toDynamicPercentPx(context, DpQualifier.HEIGHT, Inverter.LH_TO_PW, ignoreMultiWindows = true)
fun Number.phdpPwia(context: Context): Float = this.toDynamicPercentPx(context, DpQualifier.HEIGHT, Inverter.LH_TO_PW, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.pwdpLh(context: Context): Float = this.toDynamicPercentPx(context, DpQualifier.WIDTH, Inverter.PW_TO_LH)
fun Number.pwdpLha(context: Context): Float = this.toDynamicPercentPx(context, DpQualifier.WIDTH, Inverter.PW_TO_LH, applyAspectRatio = true)
fun Number.pwdpLhi(context: Context): Float = this.toDynamicPercentPx(context, DpQualifier.WIDTH, Inverter.PW_TO_LH, ignoreMultiWindows = true)
fun Number.pwdpLhia(context: Context): Float = this.toDynamicPercentPx(context, DpQualifier.WIDTH, Inverter.PW_TO_LH, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.pwdpPh(context: Context): Float = this.toDynamicPercentPx(context, DpQualifier.WIDTH, Inverter.LW_TO_PH)
fun Number.pwdpPha(context: Context): Float = this.toDynamicPercentPx(context, DpQualifier.WIDTH, Inverter.LW_TO_PH, applyAspectRatio = true)
fun Number.pwdpPhi(context: Context): Float = this.toDynamicPercentPx(context, DpQualifier.WIDTH, Inverter.LW_TO_PH, ignoreMultiWindows = true)
fun Number.pwdpPhia(context: Context): Float = this.toDynamicPercentPx(context, DpQualifier.WIDTH, Inverter.LW_TO_PH, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.psdpQualifier(context: Context, qualifiedValue: Number, qualifierType: DpQualifier, qualifierValue: Number, finalQualifierResolver: DpQualifier? = null, ignoreMultiWindows: Boolean = false, applyAspectRatio: Boolean = false, customSensitivityK: Float? = null): Float {
    val configuration = context.resources.configuration
 ...
 * é >= [qualifierValue], usa [qualifiedValue] no lugar.
 */
fun Number.phdpQualifier(context: Context, qualifiedValue: Number, qualifierType: DpQualifier, qualifierValue: Number, finalQualifierResolver: DpQualifier? = null, ignoreMultiWindows: Boolean = false, applyAspectRatio: Boolean = false, customSensitivityK: Float? = null): Float {
    val configuration = context.resources.configuration
    val qualifierMatch = getQualifierValue(qualifierType, configuration) >= qualifierValue.toFloat()
    return if (qualifierMatch) {
 ...
 * é >= [qualifierValue], usa [qualifiedValue] no lugar.
 */
fun Number.pwdpQualifier(context: Context, qualifiedValue: Number, qualifierType: DpQualifier, qualifierValue: Number, finalQualifierResolver: DpQualifier? = null, ignoreMultiWindows: Boolean = false, applyAspectRatio: Boolean = false, customSensitivityK: Float? = null): Float {
    val configuration = context.resources.configuration
    val qualifierMatch = getQualifierValue(qualifierType, configuration) >= qualifierValue.toFloat()
    return if (qualifierMatch) {
...
fun Number.toDynamicPercentPx(
    ...
    return DimenCache.getOrPut(cacheKey, context) {
        val scaledDp = calculatePercentDp(base, configuration, qualifier, inverter, ignoreMultiWindows, applyAspectRatio, customSensitivityK)
        scaledDp * density
    }
}
...
fun Number.toDynamicPercentDp(
    ...
    return DimenCache.getOrPut(cacheKey, context) {
        calculatePercentDp(base, configuration, qualifier, inverter, ignoreMultiWindows, applyAspectRatio, customSensitivityK)
    }
}