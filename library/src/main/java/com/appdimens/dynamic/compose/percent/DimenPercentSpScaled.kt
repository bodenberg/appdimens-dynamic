...
class PercentSp private constructor(
     ...
     */
    @get:Composable
    val psem: TextUnit get() = resolveNoFontScale(DpQualifier.SMALL_WIDTH)
     ...
     */
    @get:Composable
    val psspPx: Float get() = resolvePx(DpQualifier.SMALL_WIDTH)
     ...
     */
    @get:Composable
    val phspPx: Float get() = resolvePx(DpQualifier.HEIGHT)
     ...
     */
    @get:Composable
    val pwspPx: Float get() = resolvePx(DpQualifier.WIDTH)
     ...
     */
    @get:Composable
    val psemPx: Float get() = resolveNoFontScalePx(DpQualifier.SMALL_WIDTH)
     ...
     */
    @get:Composable
    val phemPx: Float get() = resolveNoFontScalePx(DpQualifier.HEIGHT)
     ...
     */
    @get:Composable
    val pwemPx: Float get() = resolveNoFontScalePx(DpQualifier.WIDTH)
}