...
class DiagonalSp private constructor(
     ...
     */
    @get:Composable
    val dgsem: TextUnit get() = resolveNoFontScale(DpQualifier.SMALL_WIDTH)
     ...
     */
    @get:Composable
    val dgsspPx: Float get() = resolvePx(DpQualifier.SMALL_WIDTH)
     ...
     */
    @get:Composable
    val dghspPx: Float get() = resolvePx(DpQualifier.HEIGHT)
     ...
     */
    @get:Composable
    val dgwspPx: Float get() = resolvePx(DpQualifier.WIDTH)
     ...
     */
    @get:Composable
    val dgsemPx: Float get() = resolveNoFontScalePx(DpQualifier.SMALL_WIDTH)
     ...
     */
    @get:Composable
    val dghemPx: Float get() = resolveNoFontScalePx(DpQualifier.HEIGHT)
     ...
     */
    @get:Composable
    val dgwemPx: Float get() = resolveNoFontScalePx(DpQualifier.WIDTH)
}