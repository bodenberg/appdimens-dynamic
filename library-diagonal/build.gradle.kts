...
mavenPublishing {
    coordinates("io.github.bodenberg", "appdimens-dynamic-diagonal", libraryVersion)
    configure(AndroidSingleVariantLibrary())
    pom {
        name.set("AppDimens Dynamic — Diagonal")
        description.set("Diagonal geometric scaling strategy (dgsdp / code.diagonal).")
