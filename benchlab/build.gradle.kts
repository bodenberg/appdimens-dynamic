/**
 * EN Benchmark module — compares AppDimens Dynamic 3.2.0 (local)
 *    vs Concorrente 1 (legacy published artifact) vs Concorrente 2 on real devices.
 *
 * PT Módulo de benchmark — compara AppDimens Dynamic 3.2.0 (local) vs
...
dependencies {
    // AppDimens Dynamic 3.2.0 — main library under test (core + scaled).
    api(project(":library"))
