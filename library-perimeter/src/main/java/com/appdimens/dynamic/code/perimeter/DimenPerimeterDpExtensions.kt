...
import com.appdimens.dynamic.perimeter.PerimeterFactors
 ...
 */
fun Number.prsdpPh(context: Context): Float = this.toDynamicPerimeterPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PH)
fun Number.prsdpPha(context: Context): Float = this.toDynamicPerimeterPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PH, applyAspectRatio = true)
fun Number.prsdpPhi(context: Context): Float = this.toDynamicPerimeterPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PH, ignoreMultiWindows = true)
fun Number.prsdpPhia(context: Context): Float = this.toDynamicPerimeterPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PH, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.prsdpLh(context: Context): Float = this.toDynamicPerimeterPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LH)
fun Number.prsdpLha(context: Context): Float = this.toDynamicPerimeterPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LH, applyAspectRatio = true)
fun Number.prsdpLhi(context: Context): Float = this.toDynamicPerimeterPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LH, ignoreMultiWindows = true)
fun Number.prsdpLhia(context: Context): Float = this.toDynamicPerimeterPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LH, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.prsdpPw(context: Context): Float = this.toDynamicPerimeterPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PW)
fun Number.prsdpPwa(context: Context): Float = this.toDynamicPerimeterPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PW, applyAspectRatio = true)
fun Number.prsdpPwi(context: Context): Float = this.toDynamicPerimeterPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PW, ignoreMultiWindows = true)
fun Number.prsdpPwia(context: Context): Float = this.toDynamicPerimeterPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PW, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.prsdpLw(context: Context): Float = this.toDynamicPerimeterPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LW)
fun Number.prsdpLwa(context: Context): Float = this.toDynamicPerimeterPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LW, applyAspectRatio = true)
fun Number.prsdpLwi(context: Context): Float = this.toDynamicPerimeterPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LW, ignoreMultiWindows = true)
fun Number.prsdpLwia(context: Context): Float = this.toDynamicPerimeterPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LW, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.prhdpLw(context: Context): Float = this.toDynamicPerimeterPx(context, DpQualifier.HEIGHT, Inverter.PH_TO_LW)
fun Number.prhdpLwa(context: Context): Float = this.toDynamicPerimeterPx(context, DpQualifier.HEIGHT, Inverter.PH_TO_LW, applyAspectRatio = true)
fun Number.prhdpLwi(context: Context): Float = this.toDynamicPerimeterPx(context, DpQualifier.HEIGHT, Inverter.PH_TO_LW, ignoreMultiWindows = true)
fun Number.prhdpLwia(context: Context): Float = this.toDynamicPerimeterPx(context, DpQualifier.HEIGHT, Inverter.PH_TO_LW, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.prhdpPw(context: Context): Float = this.toDynamicPerimeterPx(context, DpQualifier.HEIGHT, Inverter.LH_TO_PW)
fun Number.prhdpPwa(context: Context): Float = this.toDynamicPerimeterPx(context, DpQualifier.HEIGHT, Inverter.LH_TO_PW, applyAspectRatio = true)
fun Number.prhdpPwi(context: Context): Float = this.toDynamicPerimeterPx(context, DpQualifier.HEIGHT, Inverter.LH_TO_PW, ignoreMultiWindows = true)
fun Number.prhdpPwia(context: Context): Float = this.toDynamicPerimeterPx(context, DpQualifier.HEIGHT, Inverter.LH_TO_PW, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.prwdpLh(context: Context): Float = this.toDynamicPerimeterPx(context, DpQualifier.WIDTH, Inverter.PW_TO_LH)
fun Number.prwdpLha(context: Context): Float = this.toDynamicPerimeterPx(context, DpQualifier.WIDTH, Inverter.PW_TO_LH, applyAspectRatio = true)
fun Number.prwdpLhi(context: Context): Float = this.toDynamicPerimeterPx(context, DpQualifier.WIDTH, Inverter.PW_TO_LH, ignoreMultiWindows = true)
fun Number.prwdpLhia(context: Context): Float = this.toDynamicPerimeterPx(context, DpQualifier.WIDTH, Inverter.PW_TO_LH, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.prwdpPh(context: Context): Float = this.toDynamicPerimeterPx(context, DpQualifier.WIDTH, Inverter.LW_TO_PH)
fun Number.prwdpPha(context: Context): Float = this.toDynamicPerimeterPx(context, DpQualifier.WIDTH, Inverter.LW_TO_PH, applyAspectRatio = true)
fun Number.prwdpPhi(context: Context): Float = this.toDynamicPerimeterPx(context, DpQualifier.WIDTH, Inverter.LW_TO_PH, ignoreMultiWindows = true)
fun Number.prwdpPhia(context: Context): Float = this.toDynamicPerimeterPx(context, DpQualifier.WIDTH, Inverter.LW_TO_PH, ignoreMultiWindows = true, applyAspectRatio = true)
