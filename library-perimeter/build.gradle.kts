...
mavenPublishing {
    coordinates("io.github.bodenberg", "appdimens-dynamic-perimeter", libraryVersion)
    configure(AndroidSingleVariantLibrary())
    pom {
        name.set("AppDimens Dynamic — Perimeter")
        description.set("Perimeter geometric scaling strategy (prsdp / code.perimeter).")
