...
fun Number.isdpRotate(
    ...
    return if (isTargetOrientation) {
        rotationValue.toDynamicInterpolatedPx(context, finalQualifierResolver, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    } else {
        this.toDynamicInterpolatedPx(context, DpQualifier.SMALL_WIDTH, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    }
}
...
fun Number.ihdpRotate(
    ...
    return if (isTargetOrientation) {
        ...
        this.toDynamicInterpolatedPx(context, DpQualifier.HEIGHT, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    }
}
...
fun Number.iwdpRotate(
    ...
    return if (isTargetOrientation) {
        ...
        this.toDynamicInterpolatedPx(context, DpQualifier.WIDTH, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    }
}
 ...
 */
private fun Number.fastInterpolatedPx(context: Context, qualifier: DpQualifier, applyAspectRatio: Boolean): Float {
    if (DimenCache.isScalingEnabled() && (qualifier == DpQualifier.SMALL_WIDTH || !applyAspectRatio)) {
        ...
        val out = if (qualifier == DpQualifier.SMALL_WIDTH) {
            base * m.interpolatedScale
        } else {
            val dim = if (qualifier == DpQualifier.WIDTH) m.screenWidthDp.toFloat() else m.screenHeightDp.toFloat()
            val linear = base * dim * DimenCache.INV_BASE_RATIO
            base + (linear - base) * 0.5f
        }
        return if (applyAspectRatio) out * m.defaultAspectRatioMultiplier * m.density else out * m.density
    }
    return this.toDynamicInterpolatedPx(context, qualifier, applyAspectRatio = applyAspectRatio)
}

fun Number.isdp(context: Context): Float = fastInterpolatedPx(context, DpQualifier.SMALL_WIDTH, applyAspectRatio = false)
fun Number.isdpa(context: Context): Float = fastInterpolatedPx(context, DpQualifier.SMALL_WIDTH, applyAspectRatio = true)
fun Number.isdpi(context: Context): Float = this.toDynamicInterpolatedPx(context, DpQualifier.SMALL_WIDTH, ignoreMultiWindows = true)
fun Number.isdpia(context: Context): Float = this.toDynamicInterpolatedPx(context, DpQualifier.SMALL_WIDTH, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.isdpPh(context: Context): Float = this.toDynamicInterpolatedPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PH)
fun Number.isdpPha(context: Context): Float = this.toDynamicInterpolatedPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PH, applyAspectRatio = true)
fun Number.isdpPhi(context: Context): Float = this.toDynamicInterpolatedPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PH, ignoreMultiWindows = true)
fun Number.isdpPhia(context: Context): Float = this.toDynamicInterpolatedPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PH, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.isdpLh(context: Context): Float = this.toDynamicInterpolatedPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LH)
fun Number.isdpLha(context: Context): Float = this.toDynamicInterpolatedPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LH, applyAspectRatio = true)
fun Number.isdpLhi(context: Context): Float = this.toDynamicInterpolatedPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LH, ignoreMultiWindows = true)
fun Number.isdpLhia(context: Context): Float = this.toDynamicInterpolatedPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LH, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.isdpPw(context: Context): Float = this.toDynamicInterpolatedPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PW)
fun Number.isdpPwa(context: Context): Float = this.toDynamicInterpolatedPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PW, applyAspectRatio = true)
fun Number.isdpPwi(context: Context): Float = this.toDynamicInterpolatedPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PW, ignoreMultiWindows = true)
fun Number.isdpPwia(context: Context): Float = this.toDynamicInterpolatedPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PW, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.isdpLw(context: Context): Float = this.toDynamicInterpolatedPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LW)
fun Number.isdpLwa(context: Context): Float = this.toDynamicInterpolatedPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LW, applyAspectRatio = true)
fun Number.isdpLwi(context: Context): Float = this.toDynamicInterpolatedPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LW, ignoreMultiWindows = true)
fun Number.isdpLwia(context: Context): Float = this.toDynamicInterpolatedPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LW, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.ihdp(context: Context): Float = fastInterpolatedPx(context, DpQualifier.HEIGHT, applyAspectRatio = false)
fun Number.ihdpa(context: Context): Float = this.toDynamicInterpolatedPx(context, DpQualifier.HEIGHT, applyAspectRatio = true)
fun Number.ihdpi(context: Context): Float = this.toDynamicInterpolatedPx(context, DpQualifier.HEIGHT, ignoreMultiWindows = true)
fun Number.ihdpia(context: Context): Float = this.toDynamicInterpolatedPx(context, DpQualifier.HEIGHT, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.ihdpLw(context: Context): Float = this.toDynamicInterpolatedPx(context, DpQualifier.HEIGHT, Inverter.PH_TO_LW)
fun Number.ihdpLwa(context: Context): Float = this.toDynamicInterpolatedPx(context, DpQualifier.HEIGHT, Inverter.PH_TO_LW, applyAspectRatio = true)
fun Number.ihdpLwi(context: Context): Float = this.toDynamicInterpolatedPx(context, DpQualifier.HEIGHT, Inverter.PH_TO_LW, ignoreMultiWindows = true)
fun Number.ihdpLwia(context: Context): Float = this.toDynamicInterpolatedPx(context, DpQualifier.HEIGHT, Inverter.PH_TO_LW, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.ihdpPw(context: Context): Float = this.toDynamicInterpolatedPx(context, DpQualifier.HEIGHT, Inverter.LH_TO_PW)
fun Number.ihdpPwa(context: Context): Float = this.toDynamicInterpolatedPx(context, DpQualifier.HEIGHT, Inverter.LH_TO_PW, applyAspectRatio = true)
fun Number.ihdpPwi(context: Context): Float = this.toDynamicInterpolatedPx(context, DpQualifier.HEIGHT, Inverter.LH_TO_PW, ignoreMultiWindows = true)
fun Number.ihdpPwia(context: Context): Float = this.toDynamicInterpolatedPx(context, DpQualifier.HEIGHT, Inverter.LH_TO_PW, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.iwdp(context: Context): Float = fastInterpolatedPx(context, DpQualifier.WIDTH, applyAspectRatio = false)
fun Number.iwdpa(context: Context): Float = this.toDynamicInterpolatedPx(context, DpQualifier.WIDTH, applyAspectRatio = true)
fun Number.iwdpi(context: Context): Float = this.toDynamicInterpolatedPx(context, DpQualifier.WIDTH, ignoreMultiWindows = true)
fun Number.iwdpia(context: Context): Float = this.toDynamicInterpolatedPx(context, DpQualifier.WIDTH, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.iwdpLh(context: Context): Float = this.toDynamicInterpolatedPx(context, DpQualifier.WIDTH, Inverter.PW_TO_LH)
fun Number.iwdpLha(context: Context): Float = this.toDynamicInterpolatedPx(context, DpQualifier.WIDTH, Inverter.PW_TO_LH, applyAspectRatio = true)
fun Number.iwdpLhi(context: Context): Float = this.toDynamicInterpolatedPx(context, DpQualifier.WIDTH, Inverter.PW_TO_LH, ignoreMultiWindows = true)
fun Number.iwdpLhia(context: Context): Float = this.toDynamicInterpolatedPx(context, DpQualifier.WIDTH, Inverter.PW_TO_LH, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.iwdpPh(context: Context): Float = this.toDynamicInterpolatedPx(context, DpQualifier.WIDTH, Inverter.LW_TO_PH)
fun Number.iwdpPha(context: Context): Float = this.toDynamicInterpolatedPx(context, DpQualifier.WIDTH, Inverter.LW_TO_PH, applyAspectRatio = true)
fun Number.iwdpPhi(context: Context): Float = this.toDynamicInterpolatedPx(context, DpQualifier.WIDTH, Inverter.LW_TO_PH, ignoreMultiWindows = true)
fun Number.iwdpPhia(context: Context): Float = this.toDynamicInterpolatedPx(context, DpQualifier.WIDTH, Inverter.LW_TO_PH, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.isdpQualifier(context: Context, qualifiedValue: Number, qualifierType: DpQualifier, qualifierValue: Number, finalQualifierResolver: DpQualifier? = null, ignoreMultiWindows: Boolean = false, applyAspectRatio: Boolean = false, customSensitivityK: Float? = null): Float {
    val configuration = context.resources.configuration
    val qualifierMatch = getQualifierValue(qualifierType, configuration) >= qualifierValue.toFloat()
    return if (qualifierMatch) {
        qualifiedValue.toDynamicInterpolatedPx(context, finalQualifierResolver ?: DpQualifier.SMALL_WIDTH, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    } else {
        this.toDynamicInterpolatedPx(context, DpQualifier.SMALL_WIDTH, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    }
}
 ...
 * é >= [qualifierValue], usa [qualifiedValue] no lugar.
 */
fun Number.ihdpQualifier(context: Context, qualifiedValue: Number, qualifierType: DpQualifier, qualifierValue: Number, finalQualifierResolver: DpQualifier? = null, ignoreMultiWindows: Boolean = false, applyAspectRatio: Boolean = false, customSensitivityK: Float? = null): Float {
    val configuration = context.resources.configuration
    val qualifierMatch = getQualifierValue(qualifierType, configuration) >= qualifierValue.toFloat()
    return if (qualifierMatch) {
        qualifiedValue.toDynamicInterpolatedPx(context, finalQualifierResolver ?: DpQualifier.HEIGHT, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    } else {
        this.toDynamicInterpolatedPx(context, DpQualifier.HEIGHT, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    }
}
 ...
 * é >= [qualifierValue], usa [qualifiedValue] no lugar.
 */
fun Number.iwdpQualifier(context: Context, qualifiedValue: Number, qualifierType: DpQualifier, qualifierValue: Number, finalQualifierResolver: DpQualifier? = null, ignoreMultiWindows: Boolean = false, applyAspectRatio: Boolean = false, customSensitivityK: Float? = null): Float {
    val configuration = context.resources.configuration
    val qualifierMatch = getQualifierValue(qualifierType, configuration) >= qualifierValue.toFloat()
    return if (qualifierMatch) {
        qualifiedValue.toDynamicInterpolatedPx(context, finalQualifierResolver ?: DpQualifier.WIDTH, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    } else {
        this.toDynamicInterpolatedPx(context, DpQualifier.WIDTH, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    }
}
...
fun Number.isdpScreen(context: Context, screenValue: Number, uiModeType: UiModeType, qualifierType: DpQualifier, qualifierValue: Number, finalQualifierResolver: DpQualifier? = null, ignoreMultiWindows: Boolean = false, applyAspectRatio: Boolean = false, customSensitivityK: Float? = null): Float {
    ...
    return if (uiModeMatch && qualifierMatch) {
        screenValue.toDynamicInterpolatedPx(context, finalQualifierResolver ?: DpQualifier.SMALL_WIDTH, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    } else {
        this.toDynamicInterpolatedPx(context, DpQualifier.SMALL_WIDTH, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    }
}
...
fun Number.ihdpScreen(context: Context, screenValue: Number, uiModeType: UiModeType, qualifierType: DpQualifier, qualifierValue: Number, finalQualifierResolver: DpQualifier? = null, ignoreMultiWindows: Boolean = false, applyAspectRatio: Boolean = false, customSensitivityK: Float? = null): Float {
    ...
    val qualifierMatch = getQualifierValue(qualifierType, configuration) >= qualifierValue.toFloat()
    return if (uiModeMatch && qualifierMatch) {
        screenValue.toDynamicInterpolatedPx(context, finalQualifierResolver ?: DpQualifier.HEIGHT, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    } else {
        this.toDynamicInterpolatedPx(context, DpQualifier.HEIGHT, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    }
}
...
fun Number.iwdpScreen(context: Context, screenValue: Number, uiModeType: UiModeType, qualifierType: DpQualifier, qualifierValue: Number, finalQualifierResolver: DpQualifier? = null, ignoreMultiWindows: Boolean = false, applyAspectRatio: Boolean = false, customSensitivityK: Float? = null): Float {
    ...
    val qualifierMatch = getQualifierValue(qualifierType, configuration) >= qualifierValue.toFloat()
    return if (uiModeMatch && qualifierMatch) {
        screenValue.toDynamicInterpolatedPx(context, finalQualifierResolver ?: DpQualifier.WIDTH, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    } else {
        this.toDynamicInterpolatedPx(context, DpQualifier.WIDTH, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    }
}
...
fun Number.toDynamicInterpolatedPx(
    ...
    return DimenCache.getOrPut(cacheKey, context) {
        val scaledDp = calculateInterpolatedDp(base, configuration, qualifier, inverter, ignoreMultiWindows, applyAspectRatio, customSensitivityK, context)
        scaledDp * density
    }
}
...
fun Number.toDynamicInterpolatedDp(
    ...
    return DimenCache.getOrPut(cacheKey, context) {
        calculateInterpolatedDp(base, configuration, qualifier, inverter, ignoreMultiWindows, applyAspectRatio, customSensitivityK, context)
    }
}