...
mavenPublishing {
    coordinates("io.github.bodenberg", "appdimens-dynamic-fit", libraryVersion)
    configure(AndroidSingleVariantLibrary())
    pom {
        name.set("AppDimens Dynamic — Fit")
        description.set("Fit geometric scaling strategy (ftsdp / code.fit).")
...
android {
    namespace = "com.appdimens.dynamic.fit"
    compileSdk = 37
    defaultConfig {
        minSdk = 24
