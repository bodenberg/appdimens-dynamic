...
> [!NOTE]
> **Version:** `3.2.0` — modules: [MODULES.md](MODULES.md)
...
### 2.0 Maven / Gradle module graph (3.2.0)
...
1. **Module Artifacting:** Each Gradle module publishes at `appdimens.version` (`3.2.0`). Coordinates: principal `appdimens-dynamic`, strategy modules `appdimens-dynamic-<strategy>`, BOM `appdimens-dynamic-bom`. See [MODULES.md](MODULES.md).
