...
**Maven artifact (3.1.6):** `io.github.bodenberg:appdimens-dynamic-logarithmic:3.1.6`  
**Gradle module:** `:library-logarithmic` — Satellite — add this dependency to use `logsdp` / logarithmic APIs.  
