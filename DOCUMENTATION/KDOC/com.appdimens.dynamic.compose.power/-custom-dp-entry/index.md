//[AppDimens SDP, HDP, WDP: Scalable Width and Height Dimensions](../../../index.md)/[com.appdimens.dynamic.compose.power](../index.md)/[CustomDpEntry](index.md)
...
EN Represents a custom dimension entry with qualifiers and priority. Used by the DimenPowerScaled class to define specific values for screen conditions.

PT Representa uma entrada de dimensão customizada com qualificadores e prioridade. Usada pela classe DimenPowerScaled para definir valores específicos para condições de tela.
