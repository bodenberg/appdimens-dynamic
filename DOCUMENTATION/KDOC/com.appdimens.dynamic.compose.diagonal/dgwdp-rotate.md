...
PT Extensão para Dp com dimensionamento dinâmico baseado na **Largura da Tela (wDP)**. Usa o valor base por padrão, mas quando o dispositivo está na [orientation](dgwdp-rotate.md) especificada, usa [rotationValue](dgwdp-rotate.md) escalado com o [finalQualifierResolver](dgwdp-rotate.md) dado. Exemplo de uso: `30.wdpRot(45, DpQualifier.WIDTH, Orientation.LANDSCAPE)` → 30.wdp por padrão, 45 escalado por WIDTH no paisagem.
...
PT Extensão para Dp com dimensionamento dinâmico baseado na **Largura da Tela (wDP)**. Retorna o valor original **auto-escalonado** usando o qualificador especificado se a condição não for atendida. Quando o dispositivo está na [orientation](dgwdp-rotate.md) especificada, usa [rotationValue](dgwdp-rotate.md) escalado com o [finalQualifierResolver](dgwdp-rotate.md) dado.
