//[AppDimens SDP, HDP, WDP: Scalable Width and Height Dimensions](../../../index.md)/[com.appdimens.dynamic.compose.logarithmic](../index.md)/[LogarithmicSp](index.md)
...
val [loghem](loghem.md): ERROR CLASS: Symbol not found for TextUnit
...
val [loghemPx](loghem-px.md): [Float](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-float/index.html)
...
val [loghsp](loghsp.md): ERROR CLASS: Symbol not found for TextUnit
...
val [loghspPx](loghsp-px.md): [Float](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-float/index.html)
...
val [logsem](logsem.md): ERROR CLASS: Symbol not found for TextUnit
...
val [logsemPx](logsem-px.md): [Float](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-float/index.html)
...
val [logsspPx](logssp-px.md): [Float](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-float/index.html)
...
val [logwem](logwem.md): ERROR CLASS: Symbol not found for TextUnit
...
val [logwemPx](logwem-px.md): [Float](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-float/index.html)
...
val [logwsp](logwsp.md): ERROR CLASS: Symbol not found for TextUnit
...
val [logwspPx](logwsp-px.md): [Float](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-float/index.html)
...
fun [aspectRatio](aspect-ratio.md)(enable: [Boolean](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html) = true, sensitivityK: [Float](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-float/index.html)? = null): [LogarithmicSp](index.md)
...
fun [ignoreMultiWindows](ignore-multi-windows.md)(ignore: [Boolean](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html) = true): [LogarithmicSp](index.md)
...
EN Like [resolve](resolve.md) but forces `fontScale = false` (fixed Sp, same idea as `logsem` / `logwem` accessors). PT Como [resolve](resolve.md), mas força `fontScale = false` (Sp fixo, mesmo propósito dos acessores `logsem` / `logwem`).
...
EN Same as [resolve](resolve.md) but returns density-scaled pixels ([toDynamicLogarithmicPx](../to-dynamic-logarithmic-px.md)). PT Igual a [resolve](resolve.md), mas retorna pixels já escalados pela densidade ([toDynamicLogarithmicPx](../to-dynamic-logarithmic-px.md)).
