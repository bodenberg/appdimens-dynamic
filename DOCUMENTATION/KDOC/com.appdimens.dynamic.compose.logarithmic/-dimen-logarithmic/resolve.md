//[AppDimens SDP, HDP, WDP: Scalable Width and Height Dimensions](../../../index.md)/[com.appdimens.dynamic.compose.logarithmic](../index.md)/[DimenLogarithmic](index.md)/[resolve](resolve.md)
...
The dynamic scaling qualifier that will be applied at the end (SMALL_WIDTH, HEIGHT, or WIDTH), determined by the access property (.logsdp, .loghdp, .logwdp).
