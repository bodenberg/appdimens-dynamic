//[AppDimens SDP, HDP, WDP: Scalable Width and Height Dimensions](../../../index.md)/[com.appdimens.dynamic.compose.perimeter](../index.md)/[PerimeterSp](index.md)
...
val [prhem](prhem.md): ERROR CLASS: Symbol not found for TextUnit
...
val [prhemPx](prhem-px.md): [Float](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-float/index.html)
...
val [prhsp](prhsp.md): ERROR CLASS: Symbol not found for TextUnit
...
val [prsem](prsem.md): ERROR CLASS: Symbol not found for TextUnit
...
val [prsemPx](prsem-px.md): [Float](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-float/index.html)
...
val [prssp](prssp.md): ERROR CLASS: Symbol not found for TextUnit
...
val [prsspPx](prssp-px.md): [Float](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-float/index.html)
...
val [prwem](prwem.md): ERROR CLASS: Symbol not found for TextUnit
...
val [prwemPx](prwem-px.md): [Float](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-float/index.html)
...
val [prwsp](prwsp.md): ERROR CLASS: Symbol not found for TextUnit
...
val [prwspPx](prwsp-px.md): [Float](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-float/index.html)
...
fun [aspectRatio](aspect-ratio.md)(enable: [Boolean](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html) = true, sensitivityK: [Float](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-float/index.html)? = null): [PerimeterSp](index.md)
...
fun [ignoreMultiWindows](ignore-multi-windows.md)(ignore: [Boolean](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html) = true): [PerimeterSp](index.md)
...
EN Like [resolve](resolve.md) but forces `fontScale = false` (fixed Sp, same idea as `prsem` / `prwem` accessors). PT Como [resolve](resolve.md), mas força `fontScale = false` (Sp fixo, mesmo propósito dos acessores `prsem` / `prwem`).
...
EN Same as [resolve](resolve.md) but returns density-scaled pixels ([toDynamicPerimeterPx](../to-dynamic-perimeter-px.md)). PT Igual a [resolve](resolve.md), mas retorna pixels já escalados pela densidade ([toDynamicPerimeterPx](../to-dynamic-perimeter-px.md)).
