...
fun ERROR CLASS: Symbol not found for Dp.[prhdpRotatePlain](prhdp-rotate-plain.md)(rotation: ERROR CLASS: Symbol not found for Dp, orientation: [Orientation](../com.appdimens.dynamic.common/-orientation/index.md) = Orientation.LANDSCAPE): ERROR CLASS: Symbol not found for Dp

EN Plain hdp rotation: [rotation](prhdp-rotate-plain.md) and receiver already scaled; logic only. PT Rotação hdp Plain: [rotation](prhdp-rotate-plain.md) e recetor já escalados; só a lógica.
