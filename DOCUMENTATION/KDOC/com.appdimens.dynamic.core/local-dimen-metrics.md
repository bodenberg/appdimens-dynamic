...
Provided by [AppDimensProvider](-app-dimens-provider.md) (since 3.1.7). When it is `null`, the Compose helpers fall back to the window snapshot derived from the captured application context.

PT Snapshot de janela por composição. Fornecido pelo [AppDimensProvider](-app-dimens-provider.md) (desde a 3.1.7).
