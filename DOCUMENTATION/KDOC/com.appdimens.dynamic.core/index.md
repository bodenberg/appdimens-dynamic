...
| Name | Summary |
|---|---|
| [AspectRatioLookup](-aspect-ratio-lookup/index.md) |  |
...
| [ResizeRangePx](-resize-range-px/index.md) |  |
...
| Name | Summary |
|---|---|
| [AppDimensProvider](-app-dimens-provider.md) |  |
| [buildResizeStepsPx](build-resize-steps-px.md) |  |
| [fastLn](fast-ln.md) |  |
| [findActivity](find-activity.md) |  |
| [findLargestFittingResizePx](find-largest-fitting-resize-px.md) |  |
| [getCurrentUiModeType](get-current-ui-mode-type.md) |  |
| [layoutRememberStamp](layout-remember-stamp.md) |  |
| [literalPercentOfReferenceDp](literal-percent-of-reference-dp.md) |  |
| [literalPercentOfScreenDp](literal-percent-of-screen-dp.md) |  |
...
| [resizePercentSw](resize-percent-sw.md) |  |
