...
**Bulk / init:** see [toDynamicFitSpPx](to-dynamic-fit-sp-px.md) for [DimenCache.getBatch](../com.appdimens.dynamic.core/-dimen-cache/get-batch.md) and [DimenFitSp.warmupCache](-dimen-fit-sp/warmup-cache.md).
