...
**Se****enableCache****for**`true` (padrão): consulta o [DimenCache](../com.appdimens.dynamic.core/-dimen-cache/index.md) primeiro. No acerto, retorna o valor em pixels cacheado; no miss, calcula via [calculateDiagonalDp](calculate-diagonal-dp.md) e armazena.

**Se****enableCache****for**`false`: calcula diretamente via [calculateDiagonalDp](calculate-diagonal-dp.md).
