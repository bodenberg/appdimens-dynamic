...
**Bulk / init:** see [toDynamicPercentSpPx](to-dynamic-percent-sp-px.md) for [DimenCache.getBatch](../com.appdimens.dynamic.core/-dimen-cache/get-batch.md) and [DimenPercentSp.warmupCache](-dimen-percent-sp/warmup-cache.md).
