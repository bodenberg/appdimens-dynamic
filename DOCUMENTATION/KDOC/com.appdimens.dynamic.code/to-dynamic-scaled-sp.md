...
**Bulk / init:** see [toDynamicScaledSpPx](to-dynamic-scaled-sp-px.md) for [DimenCache.getBatch](../com.appdimens.dynamic.core/-dimen-cache/get-batch.md) and [DimenSsp.warmupCache](-dimen-ssp/warmup-cache.md).
