//[AppDimens SDP, HDP, WDP: Scalable Width and Height Dimensions](../../../index.md)/[com.appdimens.dynamic.code.power](../index.md)/[PowerSp](index.md)/[sortedCustomEntries](sorted-custom-entries.md)
