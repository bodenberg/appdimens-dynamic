...
**Bulk / init:** see [toDynamicInterpolatedSpPx](to-dynamic-interpolated-sp-px.md) for [DimenCache.getBatch](../com.appdimens.dynamic.core/-dimen-cache/get-batch.md) and [DimenInterpolatedSp.warmupCache](-dimen-interpolated-sp/warmup-cache.md).
