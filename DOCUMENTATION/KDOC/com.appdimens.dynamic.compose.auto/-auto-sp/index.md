//[AppDimens SDP, HDP, WDP: Scalable Width and Height Dimensions](../../../index.md)/[com.appdimens.dynamic.compose.auto](../index.md)/[AutoSp](index.md)
...
val [ahem](ahem.md): ERROR CLASS: Symbol not found for TextUnit
...
val [ahemPx](ahem-px.md): [Float](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-float/index.html)
...
val [ahsp](ahsp.md): ERROR CLASS: Symbol not found for TextUnit
...
val [ahspPx](ahsp-px.md): [Float](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-float/index.html)
...
val [asem](asem.md): ERROR CLASS: Symbol not found for TextUnit
...
val [asemPx](asem-px.md): [Float](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-float/index.html)
...
val [assp](assp.md): ERROR CLASS: Symbol not found for TextUnit
...
val [asspPx](assp-px.md): [Float](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-float/index.html)
...
val [awem](awem.md): ERROR CLASS: Symbol not found for TextUnit
...
val [awemPx](awem-px.md): [Float](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-float/index.html)
...
val [awsp](awsp.md): ERROR CLASS: Symbol not found for TextUnit
...
val [awspPx](awsp-px.md): [Float](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-float/index.html)
...
fun [aspectRatio](aspect-ratio.md)(enable: [Boolean](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html) = true, sensitivityK: [Float](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-float/index.html)? = null): [AutoSp](index.md)
...
fun [ignoreMultiWindows](ignore-multi-windows.md)(ignore: [Boolean](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html) = true): [AutoSp](index.md)
...
EN Like [resolve](resolve.md) but forces `fontScale = false` (fixed Sp, same idea as `asem` / `awem` accessors). PT Como [resolve](resolve.md), mas força `fontScale = false` (Sp fixo, mesmo propósito dos acessores `asem` / `awem`).
...
EN Same as [resolve](resolve.md) but returns density-scaled pixels ([toDynamicAutoPx](../to-dynamic-auto-px.md)). PT Igual a [resolve](resolve.md), mas retorna pixels já escalados pela densidade ([toDynamicAutoPx](../to-dynamic-auto-px.md)).
