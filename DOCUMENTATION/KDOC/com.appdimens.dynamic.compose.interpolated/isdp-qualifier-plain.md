//[AppDimens SDP, HDP, WDP: Scalable Width and Height Dimensions](../../index.md)/[com.appdimens.dynamic.compose.interpolated](index.md)/[isdpQualifierPlain](isdp-qualifier-plain.md)
...
PT Extensão para Dp com dimensionamento dinâmico baseado na **Smallest Width (swDP)**. Retorna o valor original de Dp bruto se a condição não for atendida. Quando a métrica de tela para [qualifierType](isdp-qualifier-plain.md) é >= [qualifierValue](isdp-qualifier-plain.md), usa [qualifiedValue](isdp-qualifier-plain.md) no lugar.