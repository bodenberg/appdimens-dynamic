...
EN Plain ssp rotation: [rotation](ssp-rotate-plain.md) and receiver already scaled; logic only. PT Rotação ssp Plain: [rotation](ssp-rotate-plain.md) e recetor já escalados; só a lógica.
