...
val [ihem](ihem.md): ERROR CLASS: Symbol not found for TextUnit
...
val [ihemPx](ihem-px.md): [Float](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-float/index.html)
...
val [ihsp](ihsp.md): ERROR CLASS: Symbol not found for TextUnit
...
val [ihspPx](ihsp-px.md): [Float](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-float/index.html)
...
val [isem](isem.md): ERROR CLASS: Symbol not found for TextUnit
...
val [isemPx](isem-px.md): [Float](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-float/index.html)
...
val [issp](issp.md): ERROR CLASS: Symbol not found for TextUnit
...
val [isspPx](issp-px.md): [Float](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-float/index.html)
...
val [iwemPx](iwem-px.md): [Float](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-float/index.html)
...
val [iwsp](iwsp.md): ERROR CLASS: Symbol not found for TextUnit
...
val [iwspPx](iwsp-px.md): [Float](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-float/index.html)
...
fun [aspectRatio](aspect-ratio.md)(enable: [Boolean](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html) = true, sensitivityK: [Float](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-float/index.html)? = null): [InterpolatedSp](index.md)
...
fun [ignoreMultiWindows](ignore-multi-windows.md)(ignore: [Boolean](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html) = true): [InterpolatedSp](index.md)
...
EN Like [resolve](resolve.md) but forces `fontScale = false` (fixed Sp, same idea as `isem` / `iwem` accessors). PT Como [resolve](resolve.md), mas força `fontScale = false` (Sp fixo, mesmo propósito dos acessores `isem` / `iwem`).
...
EN Same as [resolve](resolve.md) but returns density-scaled pixels ([toDynamicInterpolatedPx](../to-dynamic-interpolated-px.md)). PT Igual a [resolve](resolve.md), mas retorna pixels já escalados pela densidade ([toDynamicInterpolatedPx](../to-dynamic-interpolated-px.md)).
