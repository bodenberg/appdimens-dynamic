...
Sp→px uses `scaledSp * density * fontScale` when respecting font scale (equivalent to [android.util.TypedValue.applyDimension](https://developer.android.com/reference/kotlin/android/util/TypedValue.html#applydimension) for `COMPLEX_UNIT_SP`), else `scaledSp * density` for the fixed-Sp path. For many lookups, prefer [DimenCache.getBatch](../com.appdimens.dynamic.core/-dimen-cache/get-batch.md); for early initialization, [DimenAutoSp.warmupCache](-dimen-auto-sp/warmup-cache.md).
