...
**Bulk / init:** see [toDynamicPerimeterSpPx](to-dynamic-perimeter-sp-px.md) for [DimenCache.getBatch](../com.appdimens.dynamic.core/-dimen-cache/get-batch.md) and [DimenPerimeterSp.warmupCache](-dimen-perimeter-sp/warmup-cache.md).
