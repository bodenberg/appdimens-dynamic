...
3. 
   If [fontScale](to-dynamic-density-sp.md) is `false` (e.g. via .dnem), the system font scale is stripped.
4. 
...
3. 
   Se [fontScale](to-dynamic-density-sp.md) for `false` (ex: via .dnem), a escala de fonte do sistema é removida.
4. 
