...
fun ERROR CLASS: Symbol not found for Dp.[dsdpModePlain](dsdp-mode-plain.md)(mode: ERROR CLASS: Symbol not found for Dp, uiModeType: [UiModeType](../com.appdimens.dynamic.common/-ui-mode-type/index.md)): ERROR CLASS: Symbol not found for Dp

EN Plain sdp mode: [mode](dsdp-mode-plain.md) and receiver already scaled; logic only. PT Modo sdp Plain: [mode](dsdp-mode-plain.md) e recetor já escalados; só a lógica.
