...
fun ERROR CLASS: Symbol not found for Dp.[flwdpQualifierPlain](flwdp-qualifier-plain.md)(qualified: ERROR CLASS: Symbol not found for Dp, qualifierType: [DpQualifier](../com.appdimens.dynamic.common/-dp-qualifier/index.md), qualifierValue: [Number](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-number/index.html)): ERROR CLASS: Symbol not found for Dp

EN Plain wdp qualifier: [qualified](flwdp-qualifier-plain.md) and receiver already scaled; logic only. PT Qualificador wdp Plain: [qualified](flwdp-qualifier-plain.md) e recetor já escalados; só a lógica.
