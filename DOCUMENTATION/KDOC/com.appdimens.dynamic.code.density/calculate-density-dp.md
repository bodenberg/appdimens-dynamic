...
PT Núcleo de escalonamento puro compartilhado por [toDynamicDensityPx](to-dynamic-density-px.md) e [toDynamicDensityDp](to-dynamic-density-dp.md).
...
Se [ignoreMultiWindows](calculate-density-dp.md) for `true`, detecta split-screen via flags de layout; se ativo, retorna [baseValue](calculate-density-dp.md) sem escalar.
