...
fun ERROR CLASS: Symbol not found for Dp.[psdpModePlain](psdp-mode-plain.md)(mode: ERROR CLASS: Symbol not found for Dp, uiModeType: [UiModeType](../com.appdimens.dynamic.common/-ui-mode-type/index.md)): ERROR CLASS: Symbol not found for Dp

EN Plain sdp mode: [mode](psdp-mode-plain.md) and receiver already scaled; logic only. PT Modo sdp Plain: [mode](psdp-mode-plain.md) e recetor já escalados; só a lógica.
