//[AppDimens SDP, HDP, WDP: Scalable Width and Height Dimensions](../../../index.md)/[com.appdimens.dynamic.compose.percent](../index.md)/[PercentSp](index.md)
...
val [phem](phem.md): ERROR CLASS: Symbol not found for TextUnit
...
val [phemPx](phem-px.md): [Float](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-float/index.html)
...
val [phsp](phsp.md): ERROR CLASS: Symbol not found for TextUnit
...
val [phspPx](phsp-px.md): [Float](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-float/index.html)
...
val [psem](psem.md): ERROR CLASS: Symbol not found for TextUnit
...
val [psemPx](psem-px.md): [Float](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-float/index.html)
...
val [pssp](pssp.md): ERROR CLASS: Symbol not found for TextUnit
...
val [psspPx](pssp-px.md): [Float](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-float/index.html)
...
val [pwem](pwem.md): ERROR CLASS: Symbol not found for TextUnit
...
val [pwemPx](pwem-px.md): [Float](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-float/index.html)
...
val [pwsp](pwsp.md): ERROR CLASS: Symbol not found for TextUnit
...
val [pwspPx](pwsp-px.md): [Float](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-float/index.html)
...
fun [aspectRatio](aspect-ratio.md)(enable: [Boolean](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html) = true, sensitivityK: [Float](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-float/index.html)? = null): [PercentSp](index.md)
...
fun [ignoreMultiWindows](ignore-multi-windows.md)(ignore: [Boolean](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html) = true): [PercentSp](index.md)
...
EN Like [resolve](resolve.md) but forces `fontScale = false` (fixed Sp, same idea as `psem` / `pwem` accessors). PT Como [resolve](resolve.md), mas força `fontScale = false` (Sp fixo, mesmo propósito dos acessores `psem` / `pwem`).
...
EN Same as [resolve](resolve.md) but returns density-scaled pixels ([toDynamicPercentPx](../to-dynamic-percent-px.md)). PT Igual a [resolve](resolve.md), mas retorna pixels já escalados pela densidade ([toDynamicPercentPx](../to-dynamic-percent-px.md)).
