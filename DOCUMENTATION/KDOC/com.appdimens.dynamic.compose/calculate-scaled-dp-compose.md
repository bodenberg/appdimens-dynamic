...
Scaled Dp value as a raw [Float](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin-stdlib/kotlin/-float/index.html) (caller converts to Dp or pixels).
...
| configuration | Current [Configuration](https://developer.android.com/reference/kotlin/android/content/res/Configuration.html) snapshot from LocalConfiguration.current. |
