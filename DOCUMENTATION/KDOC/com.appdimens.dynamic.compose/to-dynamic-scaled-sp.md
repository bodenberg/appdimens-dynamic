...
2. 
   If [fontScale](to-dynamic-scaled-sp.md) is `true`, the result respects the system font size setting.
3. 
   If [fontScale](to-dynamic-scaled-sp.md) is `false` (e.g. via .sem), the system font scale is stripped.
4. 
...
2. 
   Se [fontScale](to-dynamic-scaled-sp.md) for `true`, o resultado respeita a configuração de tamanho de fonte do sistema.
3. 
   Se [fontScale](to-dynamic-scaled-sp.md) for `false` (ex: via .sem), a escala de fonte do sistema é removida.
4. 
