...
fun ERROR CLASS: Symbol not found for Dp.[fwdpModePlain](fwdp-mode-plain.md)(mode: ERROR CLASS: Symbol not found for Dp, uiModeType: [UiModeType](../com.appdimens.dynamic.common/-ui-mode-type/index.md)): ERROR CLASS: Symbol not found for Dp

EN Plain wdp mode: [mode](fwdp-mode-plain.md) and receiver already scaled; logic only. PT Modo wdp Plain: [mode](fwdp-mode-plain.md) e recetor já escalados; só a lógica.
