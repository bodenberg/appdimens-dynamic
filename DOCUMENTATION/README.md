...
**Modules (3.2.0):** principal `appdimens-dynamic` (scaled + core/common/plain); strategy modules `appdimens-dynamic-<strategy>`; BOM `appdimens-dynamic-bom`. See [README — Installation](../README.md#installation-v318) · [MODULES.md](MODULES.md).
...
| Strategy | Maven artifact (3.2.0) | Document |
|----------|------------------------|----------|
...
0a. [Modules — Maven/Gradle graph (3.2.0)](MODULES.md)  
