# AppDimens Dynamic — Gradle / Maven modules (3.2.0)
...
All published coordinates share `appdimens.version` in `gradle.properties` (**3.2.0**). Kotlin packages are unchanged since 3.1.6.
