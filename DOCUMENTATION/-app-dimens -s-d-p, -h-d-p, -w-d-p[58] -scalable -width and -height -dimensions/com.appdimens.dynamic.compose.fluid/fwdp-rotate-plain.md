...
PT Extensão para Dp com dimensionamento dinâmico baseado na **Largura da Tela (wDP)**. Retorna o valor original de Dp bruto se a condição não for atendida. Quando o dispositivo está na [orientation](fwdp-rotate-plain.md) especificada, usa [rotationValue](fwdp-rotate-plain.md) escalado com o [finalQualifierResolver](fwdp-rotate-plain.md) dado.