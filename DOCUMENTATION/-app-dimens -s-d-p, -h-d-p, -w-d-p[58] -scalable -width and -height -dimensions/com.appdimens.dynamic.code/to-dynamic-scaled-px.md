...
**Bulk resolution:** for many keys in one pass, prefer building [LongArray](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin-stdlib/kotlin/-long-array/index.html) keys with [DimenCache.buildKey](../com.appdimens.dynamic.core/-dimen-cache/build-key.md) and [DimenCache.getBatch](../com.appdimens.dynamic.core/-dimen-cache/get-batch.md). **Early init:** call [DimenSdp.warmupCache](-dimen-sdp/warmup-cache.md) (or [DimenSsp.warmupCache](-dimen-ssp/warmup-cache.md)) once with your [android.content.Context](https://developer.android.com/reference/kotlin/android/content/Context.html) so persistence/DataStore work does not land on the first hot-frame call.
