...
3. 
   If [fontScale](to-dynamic-scaled-sp.md) is `false` (e.g. via .nem), the system font scale is stripped.
4. 
...
3. 
   Se [fontScale](to-dynamic-scaled-sp.md) for `false` (ex: via .nem), a escala de fonte do sistema é removida.
4. 
