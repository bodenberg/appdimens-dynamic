...
3. 
   If [fontScale](to-dynamic-interpolated-sp.md) is `false` (e.g. via .inem), the system font scale is stripped.
4. 
...
3. 
   Se [fontScale](to-dynamic-interpolated-sp.md) for `false` (ex: via .inem), a escala de fonte do sistema é removida.
4. 
