//[AppDimens SDP, HDP, WDP: Scalable Width and Height Dimensions](../../index.md)/[com.appdimens.dynamic.compose.interpolated](index.md)/[interpolatedSp](interpolated-sp.md)
...
PT Inicia a cadeia de construção para InterpolatedSp a partir de um Int base (tratado como sp). Exemplo de uso: `16.interpolatedSp().screen(...)`.