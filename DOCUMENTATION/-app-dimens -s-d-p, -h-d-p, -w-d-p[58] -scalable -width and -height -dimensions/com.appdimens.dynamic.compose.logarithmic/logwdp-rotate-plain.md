//[AppDimens SDP, HDP, WDP: Scalable Width and Height Dimensions](../../index.md)/[com.appdimens.dynamic.compose.logarithmic](index.md)/[logwdpRotatePlain](logwdp-rotate-plain.md)
...
PT Extensão para Dp com dimensionamento dinâmico baseado na **Largura da Tela (wDP)**. Retorna o valor original de Dp bruto se a condição não for atendida. Quando o dispositivo está na [orientation](logwdp-rotate-plain.md) especificada, usa [rotationValue](logwdp-rotate-plain.md) escalado com o [finalQualifierResolver](logwdp-rotate-plain.md) dado.