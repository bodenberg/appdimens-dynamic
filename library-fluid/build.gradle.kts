...
mavenPublishing {
    coordinates("io.github.bodenberg", "appdimens-dynamic-fluid", libraryVersion)
    configure(AndroidSingleVariantLibrary())
    pom {
        name.set("AppDimens Dynamic — Fluid")
        description.set("Fluid / clamp scaling strategy (fsdp / code.fluid).")
