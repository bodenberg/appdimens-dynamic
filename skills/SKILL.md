...
**Library (3.1.6 modular):** principal `io.github.bodenberg:appdimens-dynamic:3.1.6` (scaled+core); satellites `appdimens-dynamic-<strategy>:3.1.6`. **No ALL/BOM.** See [MODULES.md](../DOCUMENTATION/MODULES.md).
...
**Packaging:** add only the strategies you use — e.g. `implementation("…:appdimens-dynamic-percent:3.1.6")`. Kotlin imports unchanged.
